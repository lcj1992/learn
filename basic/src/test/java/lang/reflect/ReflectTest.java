...
public class ReflectTest {
    @Test
    public void test() throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException, NoSuchFieldException {
        // 获取类名,包名
        ...
        String clsName = "reflect.ReflectTest$Hello";
        try {
        ...
        Person person = null;
        try {
            cls4NewInstance = Class.forName("reflect.ReflectTest$Person");
...
//        Person person2 = (Person) constructors[1].newInstance(10);
//        Person person3 = (Person) constructors[2].newInstance("fool");
//        Person person4 = (Person) constructors[3].newInstance("fool", 10);
...
//        System.out.println(person4);
    ...
    private static void printFields() {
        ...
        for (Field superField : superFields) {
            ...
            System.out.println(priv + " " + type.getName() + " " + superField.getName() + ";");
        }
    }
    ...
    public static class Chinese {
        public String nationCode = "CN";
    }

    @EqualsAndHashCode(callSuper = true)
    @Data
    public static class Person extends Chinese {
